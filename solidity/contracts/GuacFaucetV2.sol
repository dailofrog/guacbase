...
contract GuacFaucetV2 is Ownable, Pausable, ReentrancyGuard  {
    ...
    mapping(uint256 => uint256) public lastClaimTimeByFid;
    ...
    function claimGuacSigned(
        ...
        require(block.timestamp >= lastClaimTimeByFid[fid] + claimInterval, "Claim interval not met for fid");
        ...
        lastClaimTimeByFid[fid] = block.timestamp;
    }
